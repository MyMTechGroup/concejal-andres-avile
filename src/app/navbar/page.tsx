...
import { AppBar, Toolbar, Typography, Tabs, Tab, IconButton, Menu, MenuItem, Container, Box, TextField, Button } from '@mui/material';
          ...
          <Toolbar style={{ minHeight: '64px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Box sx={{ marginLeft: 2, display: 'flex', alignItems: 'center' }}>
                ...
                {searchOpen && (
                  <TextField
                    ...
                    placeholder="Buscar..."
                    size="small"
                    sx={{ backgroundColor: '#fff', borderRadius: 1, marginLeft: 1 }}
                  />
                )}
              </Box>
            </Box>
            <Box sx={{ display: { xs: 'flex', md: 'none' } }}>
              ...
              >
                ...
                <MenuItem onClick={handleMenuClose} sx={{ color: '#000' }}>Inicio</MenuItem>
                <MenuItem onClick={handleMenuClose} sx={{ color: '#000' }}>Mis Proyectos</MenuItem>
                <MenuItem onClick={handleMenuClose} sx={{ color: '#000' }}>Contacto</MenuItem>
                <MenuItem onClick={handleMenuClose} sx={{ color: '#000' }}>Mandato Cumplido</MenuItem>
              </Menu>
            </Box>
          </Toolbar>
        </Container>
